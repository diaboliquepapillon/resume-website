      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="w-64 h-64 relative transform-style-preserve-3d animate-room-spin">
          ...
          <div className="absolute w-full h-full bg-accent2/10 border-2 border-primary transform -translate-z-[128px] flex items-center justify-center">
            <Binary className="w-16 h-16 animate-float text-primary" />
          </div>
          
          {/* Right wall - Numbers */}
          <div className="absolute w-[256px] h-full bg-accent1/10 border-2 border-primary transform rotate-y-90 translate-x-[128px] flex items-center justify-center overflow-hidden">
          ...
          {/* Left wall - Formula */}
          <div className="absolute w-[256px] h-full bg-accent2/10 border-2 border-primary transform rotate-y-90 -translate-x-[128px] flex items-center justify-center">
            <div className="text-xl font-mono animate-float text-primary opacity-50">
              y = mx + b
            </div>
          </div>
          ...
          <div className="absolute w-full h-[256px] bg-accent1/10 border-2 border-primary transform rotate-x-90 translate-y-[-128px] flex items-center justify-center">
            <div className="font-mono text-sm animate-float text-primary opacity-50">
              [1 0 1]
              [0 1 0]
              [1 0 1]
            </div>
          ...
          {/* Floating text */}
          <div className="absolute inset-0 flex items-center justify-center">
            <h1 className="text-4xl font-bold text-primary animate-float">Data Science</h1>
          </div>
        </div>
      </div>
    </div>
