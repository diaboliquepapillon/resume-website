...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-r from-accent1/20 via-accent2/10 to-transparent pointer-events-none" />
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-row items-center justify-between gap-8">
          ...
          <div className="flex-1 space-y-6">
            ...
            <div className="flex flex-wrap gap-4 mt-8 animate-fade-in" style={{ animationDelay: '0.6s' }}>
              <a 
                href="#projects" 
          ...
          <div className="flex-1 animate-fade-in" style={{ animationDelay: '0.8s' }}>
            <Room />
          </div>
        </div>
      </div>
